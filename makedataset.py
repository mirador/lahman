...
def read_table(data_file, table_file, data, columns, names, titles, types, prefix):
...
def write_dict(teams_file, dict_file):
    # Read team names
    team_names = {}
    reader = csv.reader(open(teams_file, 'r'), dialect='excel')
    reader.next()
    for row in reader:
...
read_table(source_folder + 'Master.csv', 'master-table.tsv', master_data, master_columns, master_names, master_titles, master_types, '')    
print 'Done.'
...
read_table(source_folder + 'Batting.csv', 'batting-table.tsv', batting_data, batting_columns, batting_names, batting_titles, batting_types, 'BAT.')    
print 'Done.'

print 'Reading pitching table...'
read_table(source_folder + 'Pitching.csv', 'pitching-table.tsv', pitching_data, pitching_columns, pitching_names, pitching_titles, pitching_types, 'PITCH.')
print 'Done.'

print 'Reading fielding table...'
read_table(source_folder + 'Fielding.csv', 'fielding-table.tsv', fielding_data, fielding_columns, fielding_names, fielding_titles, fielding_types, 'FIELD.')
print 'Done.'
...
write_dict(source_folder + 'Teams.csv', output_folder + 'dictionary.tsv')
print '  Done.'
print 'DATASET READY.'